...
I [re-implemented](https://github.com/fg-labs/divref-wf) the existing workflow as in Snakemake wrapping a Python toolkit, with a configuration schema, GCS or AWS Open Data ingestion, and per-chromosome parallelism so a full rebuild takes less than a 20 hours on a laptop.
